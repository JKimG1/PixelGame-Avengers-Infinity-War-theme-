...
OFILES = gba.o font.o logic.o graphics.o main.o images/gauntlet.o images/win.o images/infinitywar.o images/titan_1.o images/characters.o images/ironman.o images/captain.o images/thor.o images/arrow.o
